...
//      when we write more than 5 bytes worth of data in str1, it starts to overwrite and fill str2
//      error:
//          free(): invalid size
//          Aborted (core dumped)
//
//   Why is no error raised?
//      it is not an actual error, it is a logical error. It works, just not as intended.
//   How many bytes are between the start of str1 and str2?
//      adress(str2)-adress(str1) * 4 = number of bytes
//   How could you test for this logical error?
//      valgrind
//   How could you prevent this type of error?
//      make sure that we check for the bounds
